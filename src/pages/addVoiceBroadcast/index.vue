  ...
  <div class="voice-container">
    <div class="add-voice-broadcast">
      <div class="container">
        <div class="timetwo">
          <div class="aaa">
            <van-circle v-model="currentRate" :stroke-width="6" layer-color="#F2F2F2" color="#000" :size="240" :rate="30"
              :speed="0" :text="minutesOne + '' + minutesTwo + '' + ':' + secondsOne + '' + secondsTwo" />
          </div>
        ...
        <div class="button-box">
          <div class="image-box">
            <image :src="recording === '' ? '/static/icon/recording-2.png' : '/static/icon/bigsuspend-2.png'"
              mode="widthFix" @click="toStartRecord" />
          </div>
        ...
        <van-dialog use-slot title="请填写录音广播的标题" confirm-button-color="#479CFD" :show="showConfirmDialog"
          show-cancel-button @close="showConfirmDialog = false" @confirm="toConfirmSaveVoice">
