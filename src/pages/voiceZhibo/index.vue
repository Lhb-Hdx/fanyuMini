<template>
  <div class="voice-container">
    <div class="add-voice-broadcast">
      <div class="container">
        <live-pusher audio-quality="low" :url="rtmp" :enable-camera="false" :autopush="true" mode="RTC" autoplay
          @statechange="statechange" binderror="error" style="width: 0px; height: 0px;" />
        <!-- <div class="timetwo">
        ...
        <div class="animate-box">
          <div class="animate-container">
            <div class="white-bg bg-41">
              {{ minutesOne + '' + minutesTwo + '' + ':' + secondsOne + '' + secondsTwo }}
            </div>
            <div class="white-bg bg-44" :class="{ noanimate: noanimate }"></div>
            <div class="white-bg bg-48"></div>
        ...
        <div class="button-box">
          <div class="image-box">
            <image :src="recording === '语音直播已暂停' ? '/static/icon/live-broadcast.png' : '/static/icon/bigsuspend-2.png'"
